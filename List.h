...
private:
     ...
     */
    static void disconnectLecture(std::shared_ptr<Node> next, std::shared_ptr<Node> prev);
    /**
     * Description: will remove views node if need to
     * gets the prev to the removed lecture node
     * may throw this exceptions:
     */
    static void removeViews(std::shared_ptr<Node> next, std::shared_ptr<Node> prev);
    /**
     * Description: will add lacture node to given views node
     * may throw this exceptions:
     */
    static void addLectureToViews(std::shared_ptr<Node> node_views_ptr, std::shared_ptr<Node> node_lecture_ptr);
public:
    /**
     * Description:
     * may throw this exceptions:
     ...
     * will return pointer to that lecture node
     * may throw this exceptions:
     */
     ...
     * may throw this exceptions:
     */
    void moveLecture(std::shared_ptr<Node> node_lecture_ptr, int time);
    /**
     * Description:
     * may throw this exceptions:
     */
